    ...
    <div className="mx-auto max-w-2xl px-6 py-12">
      ...
      {permission !== "granted" && permission !== "unsupported" && (
        <button
          ...
          className="mb-6 flex items-center gap-2 rounded-lg border border-gold/40 bg-gold/10 px-4 py-2.5 font-sans text-sm text-ink dark:text-cream"
        >
          <Bell className="h-4 w-4 text-gold" />
          Meldingen inschakelen voor deze browser
        </button>
      )}
      ...
      <div className="mb-8 flex items-start gap-2 rounded-lg border border-ink/10 bg-ink/[0.02] px-4 py-3 dark:border-cream/10 dark:bg-cream/[0.03]">
        ...
        <p className="font-sans text-xs leading-relaxed text-ink/60 dark:text-cream/60">
          Deze meldingen werken nu terwijl MindYou open staat in je browser. Een melding die
          afgaat ook als de app gesloten is, vraagt een extra stap (achtergrond-pushmeldingen) —
          dat bouwen we apart in als je dat wilt.
        </p>
      </div>
